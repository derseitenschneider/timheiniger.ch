<?php
/**
 * Title: Team, gray background
 * Slug: papanek/team-simple-gray
 * Categories: team
 */
?>
<!-- wp:group {"style":{"border":{"radius":"8px"},"spacing":{"padding":{"top":"var:preset|spacing|70","right":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|70"}}},"backgroundColor":"background-secondary","layout":{"type":"constrained"}} -->
