<?php
/**
 * Title: Team, dark background
 * Slug: papanek/team-black
 * Categories: team
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|70","right":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|70"}},"border":{"radius":"8px"}},"backgroundColor":"primary","textColor":"background","layout":{"type":"constrained"}} -->
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|60"}}},"fontSize":"medium"} -->
<p class="has-medium-font-size" style="margin-bottom:var(--wp--preset--spacing--60)"><?php _e('Our skilled team specializes in creating outstanding digital products.', 'papanek'); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:spacer {"height":"40px","className":"mobile-hide"} -->
